...
regressor : gradient boosting regressor (max depth 1)
data: v1
"""
...
CONFIG = dict(
    ...
    output_dir = '../models/tfidf-char-gbr-v1',
...
def main():
    ...
    pipeline = Pipeline(
            [
                ("features", features),
                ("regression", gbr(random_state=CONFIG['seed'], max_depth=CONFIG['max_depth'])),
            ],
            verbose=True
        )
